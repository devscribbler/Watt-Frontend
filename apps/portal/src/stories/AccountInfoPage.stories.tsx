...
import { changeEmailSlice } from '../store/reducers/changeEmail/changeEmailSlice'
import { changePasswordSlice } from '../store/reducers/changePassword/changePasswordSlice'
...
const templateStore = configureStore({
  ...
  preloadedState: {
    ...
    account: {
      ...
      mpan: '123456789123456789',
      mprn: '123456789123456789',
      company: {
        type: 'private',
        name: 'Test Company',
      ...
      contracts: [
        {
          ...
          provider: {
            id: '1',
            name: 'Test Electricity Supplier',
            logo_file_name: '',
...
export default {
  ...
  title: 'Portal/Pages/Account/AccountInfoPage',
} as Meta

const Template: Story<React.ComponentProps<typeof AccountInfoPage>> = (args) => {
  return (
    <>
      <Provider store={templateStore}>
        <AccountInfoPage {...args} />
      </Provider>
    </>
  )
}
