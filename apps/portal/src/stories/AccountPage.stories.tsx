...
import ChangeEmailPage from '../pages/accountPage'
...
export default {
  ...
  title: 'Portal/Pages/Account/ChangeEmailPage',
} as Meta

const Template: Story<React.ComponentProps<typeof ChangeEmailPage>> = (args) => {
  return (
    <>
