...
const GasContractSigningPage: NextPage = () => {
  const utilityTypes = useAppSelector((state: RootState) => state.form.selectedUtilities)
  const steps = getStepsBySelectedUtilityTypes({ currentPage: cfg.pages.gas.contract, utilityTypes })
...
export default GasContractSigningPage
